...
int main ()
	...
	int laco=1;
	char senhadigitada[10]="a"; // uma nova string pra conseguir colocar a senha. O "a" é só pra conseguir colocar  enão ficar algo vazio
	int comparacao;
	...
	comparacao = strcmp(senhadigitada,"admin"); //cmp é a comparação de strings
